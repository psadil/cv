...
library(vitae)
library(readr)
# https://careers.google.com/jobs/results/95286717147161286-research-scientist-consumer-health-fitbit/?company=Fitbit&q=research
```
...
```{r education}
education <- read_csv(
  here::here("data", "education-fitbit0.csv"),
  col_types = cols(
